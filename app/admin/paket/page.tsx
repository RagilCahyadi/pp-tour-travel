          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="px-6 py-6 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-col gap-3 p-4 bg-blue-50/50 rounded-xl border border-blue-100 fasilitas-input-container">
                  ...
                  <div className="w-full space-y-1 relative fasilitas-icon-select">
                  ...
                  <div className="flex items-end fasilitas-add-button-container">
                    <button
                      type="button"
                      onClick={addFacility}
                      className="h-[42px] w-full bg-[#2563eb] text-white rounded-lg flex items-center justify-center gap-2 hover:bg-blue-700 shadow-md transition-all active:scale-95 fasilitas-add-button"
                    >
                      <Plus className="w-5 h-5" />
                      <span className="fasilitas-add-button-text">Tambah</span>
                    </button>
                  </div>
                </div>
